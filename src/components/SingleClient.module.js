...
const SingleClient = (props) => {
    ...
    const getData = async () => {
      try {
        const response = await fetch(
          `https://deaksserver-version-1.herokuapp.com/adminoutletList/${props.hotel._id}`,
          {
            method: "GET",
            headers: {
  ...
  const deleteHotel = async (e) => {
    const response = await fetch(
      `https://deaksserver-version-1.herokuapp.com/hotelList/${e.target.value}`,
      {
        method: "DELETE",
  ...
  const deleteOutlet = async (e) => {
    const response = await fetch(
      `https://deaksserver-version-1.herokuapp.com/outletList/${e.target.value}`,
      {
        method: "DELETE",
